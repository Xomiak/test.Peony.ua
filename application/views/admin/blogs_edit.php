...
<table width="100%" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td valign="top">
            ...
            <form enctype="multipart/form-data" action="/admin/blogs/edit/<?=$blog['id']?>/" method="post">
                <table>
                    <tr>
                        <td>Название *:</td>
                    ...
                    <tr>
                        <td>url *:</td>
                        <td><input type="text" name="url" size="50" value="<?php if(isset($_POST['url'])) echo $_POST['url']; else echo $blog['url'];?>" /></td>
                    </tr>
                    <tr>
                        <td>Логин:</td>
                    ...
                    <tr>
                        <td>Звание:</td>
                        <td><input type="text" name="zvanie" size="50" value="<?=$blog['zvanie']?>" /></td>
                    </tr> 
                    <tr>
