        ...
        <td valign="top">
            ...
            <form enctype="multipart/form-data" action="<?=$_SERVER['REQUEST_URI']?>" method="post">
                <table>
                        ...
                        <td>
                            ...
                            <!--SELECT name="category_id"-->
                                ...
                                for($i = 0; $i < $count; $i++)
                                {
                                    ...
                                    if(isset($_POST['parent_id']) && $_POST['parent_id'] == $cat['id']) echo ' selected';
                    ...
                    <tr>
                        <td colspan="2"><input type="checkbox" name="create_topics" checked /> Создавать темы в данном разделе</td>
                    </tr>
                    <tr>
