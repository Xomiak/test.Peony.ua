    ...
    <form id="formID" method="post" action="submit.action">
        <div class="form-info popup-info" style="width: 50%;padding-right: 20px;">
            <div class="form-group">
                ...
                <label>ФИО:</label>
                <input class="validate[required]" id="form_name" type="text" name="name" value="<?php if (isset($addr['name']))
                    echo $addr['name'] ?>"/>
            ...
            <div class="form-group">
                ...
                <input class="validate[required,custom[tel]]" id="form_tel" type="text" name="tel" value="<?php if (isset($addr['tel']))
                    echo $addr['tel'] ?>"/>
